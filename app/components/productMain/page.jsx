                ...
                <div className="container px-5 py-24 mx-auto">
                    <div className="lg:w-full mx-auto flex flex-wrap">
                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-20 mt-6 lg:mt-0">
                            <h2 className="text-sm title-font text-black-500 tracking-widest">BRAND NAME</h2>
                            ...
                            <div className="flex mb-4">
                                ...
                                <span className="flex ml-3 pl-3 py-2 border-l-2 border-black-800 text-black-500 space-x-2">
                                    <a>
                            ...
                            <div className="flex mt-6 items-center pb-5 border-b-2 border-black-800 mb-5">
                                <div className="flex">
                                    ...
                                    <button className="border-2 border-black-800 rounded-full w-6 h-6 focus:outline-none"></button>
                                    <button className="border-2 border-black-800 ml-1 bg-black-700 rounded-full w-6 h-6 focus:outline-none"></button>
                                    <button className="border-2 border-black-800 ml-1 bg-indigo-500 rounded-full w-6 h-6 focus:outline-none"></button>
                                </div>
                                <div className="flex ml-6 items-center">
                                    <span className="mr-3">Size</span>
                                    <div className="relative">
                                        <select className="rounded border border-black-700 focus:ring-2 focus:ring-indigo-900 bg-transparent appearance-none py-2 focus:outline-none focus:border-indigo-500 text-white pl-3 pr-10">
                                            <option>SM</option>
                                            <option>M</option>
                                            <option>L</option>
                                            <option>XL</option>
                                        </select>
                                        <span className="absolute right-0 top-0 h-full w-10 text-center text-black-600 pointer-events-none flex items-center justify-center">
